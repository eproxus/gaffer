...
`gaffer` is licensed under the [MIT License](LICENSE.md), for all code.

## Reporting a bug

`gaffer` is not perfect software and might have bugs.

Bugs can be reported via
[GitHub issues: bug report](https://github.com/eproxus/gaffer/issues/new?template=bug_report.md).

Some contributors and maintainers may be unpaid developers working on `gaffer`, in their
...
- search, in existing [issues](https://github.com/eproxus/gaffer/issues)
...
[GitHub issues: feature request](https://github.com/eproxus/gaffer/issues/new?template=feature_request.md).

We may discuss details with you regarding the implementation, and its inclusion within the project.

We try to have as many of `gaffer`'s features tested as possible. Everything that a user
...
All fixes to `gaffer` end up requiring a +1 from one or more of the project's
maintainers.
...
`gaffer` has been improved by
[many contributors](https://github.com/eproxus/gaffer/graphs/contributors)!
